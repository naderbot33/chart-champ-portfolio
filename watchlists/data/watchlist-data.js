window.WATCHLIST_DATA = {
  "metadata": {
    "title": "Watchlists",
    "updatedAt": "2026-06-01T18:48:48.771Z",
    "neutralBandPct": 1,
  ...
  "overrides": {
    "MSTR": {
      ...
      "fundamentalsRationale": "Fundamental note should separate operating software business context from bitcoin treasury exposure."
    },
    "IREN": {
      "tags": [
    ...
    "AMD": {
      ...
      "fundamentalsRationale": [
        ...
        "Fundamentals are very strong because AMD combines AI accelerator upside, server CPU share gains, and improving profitability."
      ],
      "risks": [
    ...
    "INTC": {
      ...
      "fundamentalsRationale": [
        ...
        "Fundamentals are improving, but the risk profile is higher than cleaner AI semiconductor leaders."
      ],
      "risks": [
    ...
    "MRVL": {
      ...
      "fundamentalsRationale": [
        ...
        "Fundamentals are strong, but valuation, acquisition integration, and AI spending concentration keep the rating below Very Strong."
      ],
      "risks": [
    ...
    "MU": {
      ...
      "fundamentalsRationale": [
        ...
        "Fundamentals are very strong, though memory remains cyclical and capital intensive."
      ],
      "risks": [
    ...
    "HOOD": {
      ...
      "chartStatus": "queued",
      "fundamentalsRating": "Pending",
      "fundamentalsRationale": "Keep in stocks unless the Discord mention is specifically about crypto business exposure."
    },
    "NU": {
      "tags": [
        "fintech"
    ...
    "PFE": {
      ...
      "fundamentalsRationale": [
        ...
        "Fundamentals are moderate because Pfizer has scale and cash flow, but the market still needs clearer evidence of durable post-COVID growth."
      ],
      "risks": [
    ...
    "MPT": {
      ...
      "fundamentalsRationale": [
        ...
        "Fundamentals remain weak because balance sheet and tenant risk are still high even as rent collection shows signs of stabilization."
      ],
      "risks": [
    ...
    "BTG": {
      ...
      "chartStatus": "queued",
      "fundamentalsRating": "Pending",
      "fundamentalsRationale": "Keep in stocks as B2Gold. Add production, gold-price sensitivity, and jurisdiction notes after review."
    },
    "SOFI": {
      "tags": [
        "fintech"
      ...
      "fundamentalsRationale": [
        ...
        "Fundamentals are strong, but lending cyclicality, credit risk, and valuation keep the rating below Very Strong."
      ],
      "risks": [
    ...
    "QQQ": {
      ...
      "fundamentalsRationale": [
        ...
        "The strongest holdings have durable cash flow, AI and cloud exposure, and strong balance sheets.",
        "Fundamentals are strong at the index level, but concentration in mega-cap growth stocks keeps valuation and positioning risk elevated.",
        "Because QQQ is an ETF, the rating reflects the quality, earnings power, and concentration risk of the underlying holdings rather than a single company."
      ],
      "risks": [
      ...
      "recentUpdates": [
        {
          ...
          "timeframe": "Daily",
          "price": "~$740.67",
          "summary": "QQQ remains strong but is extended short-term as price presses into the $740.01 fib resistance area. Bulls remain in control while price holds above the $724.47-$727.74 support area.",
          "sections": [
            {
              "heading": "Context for the Move",
              "items": [
                "QQQ has continued trending higher after the March/April reversal and remains in a strong daily uptrend.",
                "Price is testing the $740.01 fib area, with the next major resistance zone at $790.22 if momentum continues.",
                "The move is extended short-term, so a pause or pullback near resistance would not be unusual."
              ]
            },
            {
              "heading": "Key Levels",
              "items": [
                "Support: $727.74 -> $724.47 -> $700.60 -> $695.31 weekly 7 EMA -> $672.91",
            ...
            },
            {
              "heading": "Signals",
              "items": [
                "Bullish: QQQ remains above the $724.47-$727.74 short-term support area, keeping trend control with buyers.",
                "Bearish: A rejection at $740.01 would raise pullback risk toward $727.74, $724.47, or deeper support near $700.60."
              ]
            },
            {
              "heading": "Bias",
              "items": [
                "Bullish but extended short-term while QQQ holds above $724.47-$727.74; cautious into $740.01 resistance."
              ]
            }
          ]
        }
    ...
    "SPY": {
      ...
      "fundamentalsRationale": [
        ...
        "Fundamentals are strong at the index level, but valuation, rates, and narrow leadership can still create pullback risk."
      ],
      "risks": [
